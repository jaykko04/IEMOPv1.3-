   ...
   <div class="card" style="border-radius: 15px;">
          ...
          <hr class="mx-n3">
            <div class="row align-items-center pt-4 pb-3">
             ...
             <div class="row align-items-center pt-4 pb-3">
              ...
              <div class="col-xl-10 order-xl-1">
                ...
                <input type="text" class="form-control form-control-lg" name="rt" id="rt"  />
              ...
              <div class="col-xl-10 order-xl-1">
                ...
                <input type="text" class="form-control form-control-lg" name="ct" id="ct" />
             ...
             <div class="row align-items-center pt-4 pb-3">
              ...
              <div class="col-xl-10 order-xl-1">
                ...
                <input type="text" class="form-control form-control-lg" name="ft" id="ft" />
             ...
             <div class="row align-items-center pt-4 pb-3">
              ...
              <div class="col-xl-10 order-xl-1">
                ...
                <input type="text" class="form-control form-control-lg" name="NMFhst" id="NMFhst" />
            ...
            <div class="row align-items-center pt-4 pb-3">
              ...
              <div class="col-xl-10 order-xl-1">
                <input type="text" class="form-control form-control-lg" name="tf" id="tf" />
             ...
             <div class="row align-items-center pt-4 pb-3">
              ...
              <div class="col-xl-10 order-xl-1">
                <input type="text" class="form-control form-control-lg" name="type" id="type" />
             ...
             <div class="row align-items-center pt-4 pb-3">
              ...
              <div class="col-xl-10 order-xl-1">
                <input type="text" class="form-control form-control-lg" name="region" id="region" />
